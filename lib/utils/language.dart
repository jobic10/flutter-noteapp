//Should you wish to change to another language, you do not need to check any
// other file. All words, sentences and whatnot are contained here
class Language {
  ...
  static final String catStudy = "Study";
  static final String appName = "Note Keeper Mini App";
  static final String smallContentTitle = "Content Too Small";
  ...
  static final String noteNotAddedTitle = "Error";
}
